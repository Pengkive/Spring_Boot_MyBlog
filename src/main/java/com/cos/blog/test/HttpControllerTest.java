...
public class HttpControllerTest {
	...
	@PostMapping("/http/post") //row data -> (default)text/plain , application/json
	public String postTest(@RequestBody Member m) { //MessageConverter (스프링부트, 자동으로 row data 키값 반영해줌)
